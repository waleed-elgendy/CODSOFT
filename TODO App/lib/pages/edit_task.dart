...
class _EditTaskState extends State<EditTask> {
  ...
  void initState() {
    ...
    dateController.text =
        widget.task.date == null ? "" : widget.task.date.toString();
    timeController.text =
        widget.task.time == null ? "" : widget.task.time.toString();
    notesController.text =
        widget.task.notes == null ? "" : widget.task.notes.toString();
    ...
    return BlocProvider(
      ...
      child:
        ...
        if (state is AddTaskFailure) {
          isLoading = false;
          showSnackBar(
              context, 'try again', "Edit failed", ContentType.failure);
        }
